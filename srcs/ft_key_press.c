...
/*   Updated: 2021/05/11 15:56:14 by gpaeng           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_rotate_player(t_all *all, double speed)
{
	...
	all->player.dir_x = all->player.dir_x * cos(speed)
	- all->player.dir_y * sin(speed);
	all->player.dir_y = old_dir_x * sin(speed)
	+ all->player.dir_y * cos(speed);
	old_plane_x = all->player.plane_x;
	all->player.plane_x = all->player.plane_x * cos(speed)
	- all->player.plane_y * sin(speed);
	all->player.plane_y = old_plane_x * sin(speed)
	+ all->player.plane_y * cos(speed);
}
